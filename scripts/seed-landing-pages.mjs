...
const pages = [
  ...
  {
    campaignSegment: "lipedema-treatment",
    slug: "lp-lipedema-riyadh",
    title: "علاج الوذمة الشحمية في الرياض",
    titleEn: "Lipedema Treatment in Riyadh",
    headline: "تقييم متخصص للوذمة الشحمية بخطة علاجية واضحة",
    eyebrow: "علاج الوذمة الشحمية",
    intro:
      "إذا كنتِ تعانين من ألم أو انتفاخ موضعي في الساقين أو الفخذين مع صعوبة في الاستجابة للرياضة، يبدأ القرار بتقييم متخصص لمرحلة الوذمة وخيارات العلاج.",
    serviceSlug: "lipedema-treatment",
    serviceLabel: "علاج الوذمة الشحمية",
    sourceLabel: "صفحة هبوط - علاج الوذمة الشحمية",
    accent: "#4a2d6b",
    image: "/media/reference/legacy/88985959.webp",
    offer: "تقييم أعراض الوذمة ومرحلة الحالة",
    bullets: [
      "تقييم توزيع الدهون والألم ومرحلة الوذمة الشحمية.",
      "شرح الفرق بين الوذمة الشحمية والسمنة أو الدهون العادية.",
      "مناقشة خيارات العلاج الجراحي وغير الجراحي حسب الحالة.",
      "خطة متابعة واقعية مع فريق متخصص في ريجوفيرا.",
    ],
    sections: [
      ["تشخيص دقيق", "فهم الأعراض ومرحلة الوذمة قبل أي قرار علاجي."],
      ["خطة مخصصة", "اختيار المسار المناسب حسب شدة الحالة والأهداف."],
      ["متابعة واضحة", "شرح التعافي والنتائج المتوقعة بخطوات محددة."],
    ],
    faqs: [
      ["هل الوذمة الشحمية مثل السمنة؟", "لا، لها طبيعة مختلفة وتحتاج تقييمًا متخصصًا قبل العلاج."],
      ["هل كل الحالات تحتاج جراحة؟", "لا، يحدد الطبيب الخطة بعد الفحص ومرحلة الحالة."],
      ["هل يمكن العلاج في الرياض؟", "نعم، يمكن بدء التقييم داخل مركز ريجوفيرا بالرياض."],
    ],
  },
  {
    campaignSegment: "brand-booking",
    slug: "lp-rejuvera-book-riyadh",
    title: "حجز استشارة في ريجوفيرا الرياض",
    titleEn: "Book a Consultation at Rejuvera Riyadh",
    headline: "احجزي استشارتك في ريجوفيرا بخطوات بسيطة وسريعة",
    eyebrow: "ريجوفيرا | Rejuvera Center",
    intro:
      "لمن يبحثون عن مركز ريجوفيرا أو يريدون حجز استشارة مباشرة، اتركي بياناتك وسيتواصل فريق الاستقبال لتأكيد الموعد والخدمة المناسبة.",
    serviceSlug: "general-inquiry",
    serviceLabel: "حجز استشارة",
    sourceLabel: "صفحة هبوط - حجز ريجوفيرا",
    accent: "#5c2484",
    image: "/media/curated/clinic-interior.jpeg",
    offer: "تأكيد سريع لطلب الحجز",
    bullets: [
      "حجز مباشر لاستشارة في مركز ريجوفيرا بالرياض.",
      "توجيهك للخدمة أو الطبيب الأنسب بعد التواصل.",
      "فريق استقبال يتابع الطلب خلال ساعات العمل.",
      "تجربة هادئة وخصوصية كاملة من أول تواصل.",
    ],
    sections: [
      ["حجز سريع", "اسم ورقم جوال فقط للبدء."],
      ["توجيه دقيق", "نحدد الخدمة المناسبة بعد فهم احتياجك."],
      ["مركز متكامل", "جراحة تجميل، جلدية، نساء، وأجهزة في مكان واحد."],
    ],
    faqs: [
      ["هل هذه الصفحة الرسمية لريجوفيرا؟", "نعم، هذه صفحة حجز تابعة لمركز ريجوفيرا الطبي بالرياض."],
      ["هل أحتاج اختيار خدمة الآن؟", "يمكنك ترك طلب حجز عام وسيتم توجيهك بعد التواصل."],
      ["متى يتم الرد؟", "خلال ساعات العمل الرسمية للمركز."],
    ],
  },
  {

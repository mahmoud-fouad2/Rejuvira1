...
const seedSettings: SettingsGroup[] = [
  {
    ...
    fields: [
      { key: "phone", label: "الرقم الرئيسي", value: "+966 55 000 0000" },
      {
        key: "email",
        label: "البريد الرسمي",
        value: "hello@rejuveracenter.com",
      },
      { key: "whatsapp", label: "واتساب", value: "+966 55 000 0000" },
    ],
  },
  {
    key: "brand",
...
const seedAdminUsers: AdminUserRecord[] = [
  {
    id: "user-super-admin",
    name: "مدير المنصة",
    email: "admin@rejuveracenter.com",
  ...
  },
  {
    ...
    name: "مسؤول التشغيل",
    email: "operations@rejuveracenter.com",
    role: UserRole.ADMIN,
    leadCount: 31,
  ...
  },
  {
    ...
    name: "مسؤول المحتوى",
    email: "content@rejuveracenter.com",
...
export async function getRuntimeSettings(): Promise<RuntimeSettings> {
  ...
  return {
    contact: {
      phone: getValue("contact", "phone", "+966 55 000 0000"),
      email: getValue("contact", "email", "hello@rejuveracenter.com"),
      whatsapp: getValue("contact", "whatsapp", "+966 55 000 0000"),
    },
    brand: {

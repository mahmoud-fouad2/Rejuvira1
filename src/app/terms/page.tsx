...
const sections = [
  ...
  {
    id: "booking",
    ar: "الحجز والإلغاء والمواعيد",
    en: "Booking, scheduling & cancellation",
  },
        ...
        <div className="rv-legal-grid">
          ...
          <article className="rv-legal-prose">
            <header>
              ...
              <p className="rv-legal-lead">
                <span className="lang-ar">
                  باستخدامك موقع {settings.brand.siteName} أو حجز خدمة عبره،
                  تكونين قد وافقت على الشروط الواردة أدناه. صيغت هذه الشروط
                  بأسلوب واضح ومباشر يعكس الطابع التشغيلي للمركز ويوضح ما يمكن
                  توقعه قبل وبعد الزيارة.
                </span>
                <span className="lang-en">
                  By using the {settings.brand.siteName} site or booking a
                  service through it, you accept the terms below. They are
                  written in a clear, direct tone that reflects how the clinic
                  actually operates.
                </span>
              </p>
            </header>
            ...
            <section id="services">
              ...
              <p>
                <span className="lang-ar">
                  يقدم المركز خدمات في مجال الجلدية والتجميل الطبي بإشراف فريق
                  طبي متخصص. تُعرض الخدمات والأجهزة والأطباء على الموقع بصورة
                  تعريفية فقط، ولا تشكّل وعدًا بنتيجة معينة، إذ تخضع كل حالة
                ...
                <span className="lang-en">
                  ...
                  promise of a specific outcome; every case requires independent
            ...
            <section id="booking">
              <h2>
                ...
                <span className="lang-en">
                  3) Booking, scheduling &amp; cancellation
                </span>
              </h2>
              <ul>
                <li>
                  <span className="lang-ar">
                    إرسال نموذج الحجز لا يعدّ تأكيدًا للموعد، ويتم الرد عليه
                    خلال الفترة التشغيلية المعلنة.
                  </span>
                  <span className="lang-en">
                    Submitting a booking form does not confirm an appointment;
                    we reply within the published operating window.
                  </span>
                </li>
                <li>
                  <span className="lang-ar">
                    يلتزم المراجع بدقة المعلومات المقدمة، وله الحق في إعادة
                    الجدولة أو الإلغاء وفق سياسة المركز المعلنة عند تأكيد الحجز.
                  </span>
                  <span className="lang-en">
                    You agree that information you submit is accurate, and you
                    may reschedule or cancel as per the clinic policy disclosed
                    at booking confirmation.
                  </span>
                </li>
                <li>
                  <span className="lang-ar">
                    قد يُطلب دفع مقدم لتأكيد المواعيد المتعلقة بإجراءات معينة،
                    ويُوضّح ذلك قبل الاعتماد.
                  </span>
                  <span className="lang-en">
                    Some appointments may require a deposit, which will be
            ...
            <section id="medical">
              ...
              <p>
                <span className="lang-ar">
                  المحتوى المقدم على الموقع لأغراض تثقيفية، ولا يحلّ محل
                  الاستشارة الطبية المباشرة. القرارات العلاجية والتجميلية تخضع
                  لتقييم سريري داخل المركز، وتُتخذ بعد فهم الحالة وشرح الخيارات
                  وحدودها.
                </span>
                <span className="lang-en">
                  Content on this site is provided for educational purposes and
                  does not replace direct medical consultation. Treatment and
                  aesthetic decisions are made after in-clinic clinical
                  assessment and a clear explanation of options and their
                  limits.
                </span>
              </p>
            </section>
            ...
            <section id="ip">
              ...
              <p>
                <span className="lang-ar">
                  جميع العناصر المعروضة على الموقع — بما في ذلك النصوص، الصور،
                  الفيديوهات، العلامات، التصميم، والبنية التقنية — مملوكة للمركز
                  أو لمن منح المركز ترخيصًا باستخدامها. يُمنع النسخ أو إعادة
                  النشر دون إذن خطي.
                </span>
                <span className="lang-en">
                  All materials on the site — including text, imagery, video,
                  marks, design, and technical structure — are owned by the
                  clinic or licensed to it. Reproduction or redistribution
            ...
            <section id="use">
              ...
              <ul>
                <li>
                  ...
                  <span className="lang-en">
                    Use the site for personal, lawful purposes only.
                  </span>
                </li>
                <li>
                  <span className="lang-ar">
                    عدم محاولة الوصول إلى مناطق محمية أو تنفيذ هجمات أو إساءة
                    استخدام النماذج.
                  </span>
                  <span className="lang-en">
                    Do not attempt to access protected areas, conduct attacks,
                    or abuse forms.
                  </span>
                </li>
                <li>
                  ...
                  <span className="lang-en">
                    Do not impersonate others or knowingly provide misleading
                    information.
                  </span>
                </li>
              </ul>
            ...
            <section id="third-party">
              ...
              <p>
                <span className="lang-ar">
                  قد يرتبط الموقع بمحتوى من أطراف ثالثة (مثل خرائط جوجل، حسابات
                  التواصل الاجتماعي، أو خدمات الدفع). لا يتحمل المركز مسؤولية
                  محتوى هذه المنصات أو سياساتها.
                </span>
                <span className="lang-en">
                  The site may link to third-party content (e.g. Google Maps,
                  social accounts, or payment services). The clinic is not
                  responsible for those platforms or their policies.
                </span>
              </p>
            </section>
            ...
            <section id="liability">
              ...
              <p>
                <span className="lang-ar">
                  ضمن الحدود التي يجيزها النظام، لا يتحمل المركز المسؤولية عن
                  الأضرار غير المباشرة الناتجة عن استخدام الموقع أو الاعتماد على
                  محتواه بمعزل عن الاستشارة الطبية المباشرة. لا تخل هذه الفقرة
                  بالحقوق المنصوص عليها في الأنظمة المعمول بها في المملكة
                  العربية السعودية.
                </span>
                <span className="lang-en">
                  To the extent permitted by law, the clinic is not liable for
                  indirect damages resulting from use of the site or reliance on
                  its content outside of direct medical consultation. This
                  clause does not affect rights granted under applicable laws of
            ...
            <section id="governing">
              ...
              <p>
                <span className="lang-ar">
                  تخضع هذه الشروط للأنظمة المعمول بها في المملكة العربية
                  السعودية، وتختص المحاكم السعودية بالنظر في أي نزاع ينشأ عنها.
                </span>
                <span className="lang-en">
                  These terms are governed by the laws of the Kingdom of Saudi
                  Arabia, and any dispute arising from them shall be subject to
                  the jurisdiction of the Saudi courts.
                </span>
              </p>
            </section>
            ...
            <section id="changes">
              ...
              <p>
                <span className="lang-ar">
                  قد يتم تعديل هذه الشروط من وقت لآخر. يسري التعديل من تاريخ
                  نشره على الموقع، ويُنصح بمراجعتها بشكل دوري.
                </span>
                <span className="lang-en">
                  These terms may be updated from time to time. Changes take
                  effect when published on the site; we recommend reviewing them
                  periodically.
                </span>
              </p>
            </section>

...
export const metadata: Metadata = {
  title: "من نحن — Rejuvira Center",
  description:
    "تعرف على Rejuvira Center، فلسفة العمل، والمنهج الطبي الذي يقود تقديم الخدمات الجلدية والتجميلية بصورة واضحة ومنظمة.",
};
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            ...
            <div className="flex flex-col gap-4 lg:items-end">
              <Link href="/contact" className="btn-primary">
                <span className="lang-ar">احجز استشارتك</span>

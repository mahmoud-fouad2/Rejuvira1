...
const values = [
  {
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-purple-mid">
    ...
    descEn: "Enhancement that respects your natural features, with precise and safe techniques.",
  },
  {
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-purple-mid">
    ...
    descEn: "Every treatment plan is tailored specifically to your individual needs and expectations.",
  },
  {
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-purple-mid">
    ...
    descEn: "A specialist medical team oversees every step, with careful follow-up on results.",
  },
];
    ...
    <section className="py-[var(--space-section)]">
      <div className="mx-auto max-w-[var(--max-width)] px-6 lg:px-10">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {values.map((v) => (
            <div key={v.titleAr} className="surface-panel group px-8 py-10 transition-all duration-500 hover:-translate-y-1 hover:shadow-[var(--shadow-elevated)]">
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-ghost/50">{v.icon}</div>

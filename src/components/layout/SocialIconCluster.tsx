...
const CHANNELS: ChannelDescriptor[] = [
  ...
  },
  {
    ...
    label: "Snapchat",
    paths: [
      "M12 2.8c2.6 0 4.6 1.8 4.6 4.8 0 .7-.05 1.35-.09 1.9-.03.43-.06.8-.03 1.05.06.5.7.78 1.32 1 .42.15.76.28.76.62 0 .62-1.14 1.12-2.25 1.45.32.78.9 1.38 1.74 1.79.4.19.67.34.67.65 0 .51-.9.85-2.72 1.02-.17.19-.3.44-.44.69-.24.44-.47.88-1 .88-.25 0-.57-.08-.94-.17-.43-.1-.91-.22-1.43-.22-.63 0-1.07.27-1.54.57-.57.36-1.16.73-2.03.73s-1.46-.37-2.03-.73c-.47-.3-.91-.57-1.54-.57-.52 0-1 .12-1.43.22-.37.09-.69.17-.94.17-.53 0-.76-.44-1-.88-.14-.25-.27-.5-.44-.69-1.82-.17-2.72-.51-2.72-1.02 0-.31.27-.46.67-.65.84-.41 1.42-1.01 1.74-1.79-1.11-.33-2.25-.83-2.25-1.45 0-.34.34-.47.76-.62.62-.22 1.26-.5 1.32-1 .03-.25 0-.62-.03-1.05-.04-.55-.09-1.2-.09-1.9 0-3 2-4.8 4.6-4.8Z",
    ],
  },
  {
    key: "tiktok",
  ...
  return (
    ...
    >
      {visibleChannels.map((channel) => {
        ...
        return (
          <li key={channel.key}>
            {/* External URLs use plain anchors because typedRoutes only covers internal paths. */}
            <a
              href={url}
              target="_blank"

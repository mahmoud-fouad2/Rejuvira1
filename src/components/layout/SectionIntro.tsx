...
export function SectionIntro({
  ...
  return (
    <header className={`max-w-2xl ${className}`}>
      ...
      <h2 className={`section-intro-title scroll-reveal heading-serif ${titleClassName}`}>
        <span className="lang-ar">{titleAr}</span>
        <span className="lang-en">{titleEn}</span>
      </h2>
      {(leadAr || leadEn) && (
        <p className="section-intro-lead text-pretty text-lg leading-9 text-text-secondary lg:text-xl lg:leading-10">

...
export function V0DoctorQuotesSlider({
  homepage,
  doctors,
}: V0DoctorQuotesSliderProps) {
  const { lang } = useLanguage();
  const slides = doctors.filter((d) => d.summary.trim().length > 0);
  const { ref, next, prev, slideProps, viewportProps } = useSnapCarousel(
    slides.length,
    {
      autoplayMs: 6500,
  ...
  return (
    <section
      className="rv-v0-section rv-v0-doctor-quotes-section"
      aria-labelledby="rv-doctor-quotes-heading"
    >
      ...
      <div className="rv-v0-doc-quotes-shell">
        ...
        <div ref={ref} className="rv-v0-doc-quotes-viewport" {...viewportProps}>
          {slides.map((doctor, i) => (
            <article
              key={doctor.id}
              className="rv-v0-doc-quote-slide"
              {...slideProps(i)}
            >
                ...
                <footer className="rv-v0-doc-quote-footer">
                  ...
                  <div className="rv-v0-doc-quote-meta">
                    ...
                    <Link
                      ...
                      className="rv-v0-doc-quote-link"
                    >
